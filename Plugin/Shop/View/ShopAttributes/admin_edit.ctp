...
<?php echo $this->Form->create('ShopAttribute', array('url' => array('action' => 'edit')));?>
	<fieldset>
 		<legend><?php echo __('Admin Edit Shop Attribute');?></legend>
	<?php
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $this->Form->value('ShopAttribute.id'))); ?></li>
